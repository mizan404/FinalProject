...
<div class="container">
    <ul class="nav nav-pills">
        <li class="active"><a data-toggle="tab" href="#save">Admin Save &nbsp; </a></li>
        <li><a data-toggle="tab" href="#update">Admin Update &nbsp; </a></li>
        <li><a data-toggle="tab" href="#ViewAndDelete"> Admin View And Delete</a></li>
