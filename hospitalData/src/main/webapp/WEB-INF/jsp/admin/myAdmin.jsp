    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bgm" >
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="nav navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item" role="presentation"><a class="nav-link " href="/hospitalpage"><span>Hospital Management</span></a></li>

                <li class="nav-item" role="presentation"><a class="nav-link " href="/adminpage"></i><span>Admin Management</span></a></li>
