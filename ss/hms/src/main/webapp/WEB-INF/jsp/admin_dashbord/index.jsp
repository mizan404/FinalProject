        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="/doctor/doctors"><i class="fa fa-user-md"></i> <span>Doctors</span></a>
                    </li>
                    <li>
                        <a href="/admin/patient"><i class="fa fa-wheelchair"></i> <span>Patients</span></a>
                    </li>
                    <li>
                        <a href="/admin/appointment"><i class="fa fa-calendar"></i> <span>Appointments</span></a>
                    </li>

                    <li>
                        <a href="/admin/department"><i class="fa fa-hospital-o"></i> <span>Departments</span></a>
                    </li>
                    <li class="submenu">
                        <a href="#"><i class="fa fa-user"></i> <span> Employees </span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            <li><a href="/admin/employees">Employees List</a></li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="/admin/salary"> Employee Salary </a></li>
                            <li><a href="/admin/salary-view"> Payslip </a></li>
                        </ul>
                    </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="/admin/compose">Compose Mail</a></li>

                        </ul>
                    </li>

                    <li>
                        <a href="/admin/assets"><i class="fa fa-cube"></i> <span>Assets</span></a>
                    </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a href="/admin/invoice-reports"> Invoice Report </a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="/admin/calender"><i class="fa fa-calendar"></i> <span>Calendar</span></a>
                    </li>
